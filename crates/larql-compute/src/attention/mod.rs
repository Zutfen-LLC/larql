...
pub use rope::{
    ...
    apply_rope_partial_at_full, apply_rope_partial_at_full_with_mode, apply_rope_partial_at_scaled,
    build_rope_inv_freq, build_rope_inv_freq_with_mode, RopeFreqMode,
};
